                    ...
                    <div class="d-flex flex-column">
                      ...
                      <p>
                        <strong
                          ...
                          {{
                            ["A", "B", "C", "D", "E"][
                              selectedQuestion.jawaban_latihan
                                ? selectedQuestion.jawaban_latihan.jawaban
                                : ""
                            ]
                          }}</strong
                        >
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <strong>{{ answeredQuestions - latihan_soal.length }}</strong> soal
            yang belum terjawab
          </div>
...
export default {
  ...
  methods: {
    finishSegment(latihanId) {
      ...
      this.loading = true;
      axios
        .post(`/api/finish_segment/${latihanId}`, {
    ...
    isQuestionAnswered(index) {
      ...
      const userAnswer = question.jawaban_latihan
        ? question.jawaban_latihan.jawaban
        : null;
    ...
    flagQuestion(pilihanIndex, event) {
      ...
      axios
        .post(`/api/flag-latihan-answer/${this.segment_latihan_id}`, {
    ...
    deleteFlagQuestion(pilihanIndex, event) {
      ...
      axios
        .post(`/api/delete-flag-latihan-answer/${this.segment_latihan_id}`, {
          questionId: questionId,
          user_id: this.user.id,
        })
        .then((response) => {
    ...
    removeQuestion(pilihanIndex, event) {
      ...
      axios
        .post(`/api/delete-latihan-answer/${this.segment_latihan_id}`, {
          questionId: questionId,
          user_id: this.user.id,
        })
        .then((response) => {
    ...
    jawabanKamu(questionIndex, optionIndex) {
      ...
      let jawaban = question.jawaban_latihan
        ? question.jawaban_latihan.jawaban
        : "";
    ...
    selectAnswer(index) {
      ...
      axios
        .post(`/api/save-latihan-answer/${this.segment_latihan_id}`, {
