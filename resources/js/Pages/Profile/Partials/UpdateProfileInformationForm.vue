    ...
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            <div class="form-group">
                ...
                <TextInput id="name" type="text" class="form-control shadow-none" v-model="form.name" required autofocus
                    autocomplete="name" />
            ...
            <div class="form-group">
                ...
                <TextInput id="email" type="email" class="form-control shadow-none" v-model="form.email" required
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton class="btn bg-main text-white" :disabled="form.processing">Save</PrimaryButton>
