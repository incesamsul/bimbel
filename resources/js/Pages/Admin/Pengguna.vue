...
<template>
  ...
  <AuthenticatedLayout :user="user">
    <div class="container-fluid">
      ...
      <p class="mb-4">
        Manajemen pengguna, tambah, cari, hapus dan ubah data pengguna aplikasi
        ini.
      </p>
      ...
      <div class="card border-0 mb-4">
        <div
          class="card-header py-3 bg-main d-flex justify-content-between align-items-center"
        >
          ...
          <form @submit.prevent="submit">
            ...
            <div class="modal-footer">
              <PrimaryButton
                ...
                class="btn bg-main text-white btn-submit-data"
              >
                Register
              </PrimaryButton>
            </div>
...
export default {
  ...
  methods: {
    submitUserData() {
      ...
      if (this.id != "") {
        ...
        showFlashMessage("data berhasil diubah");
        this.resetForm();
      } else {
        axios.post("/admin/pengguna", {
          name: this.name,
          email: this.email,
          whatsapp: this.whatsapp,
          role: this.role,
        ...
        showFlashMessage("data berhasil ditambahkan");
        this.resetForm();
      }
    },
    resetForm() {
    ...
    deleteUser(id) {
      ...
      if (confirm("yakin ingin menghapus data?")) {
        // Make API request to delete row
        axios.delete(`/admin/pengguna/${id}`);
        showFlashMessage("data berhasil terhapus");
      }
    },
    updateUser(user) {
      // Make API request to update row using axious
      this.id = user.id;
      this.name = user.name;
  ...
  mounted() {
    ...
    $(document).on("click", ".btn-filter", function () {
      ...
      const newURL = `/admin/pengguna-datatable?email=${email}`;
    ...
    $(document).on("click", ".btn-reset-filter", function () {
      const newURL = `/admin/pengguna-datatable`;
