          ...
          <div class="col-sm-4 mt-3">
            <div class="card border-0 pt-3">
              <div class="card-body text-center">
                ...
                <h6>Rp. {{ Number(total_transaksi).toLocaleString() }}</h6>
              </div>
            </div>
          </div>
        </template>
...
export default {
  props: {
    ...
    total_paket_video: Number,
    total_paket_text: Number,
    total_paket_latihan: Number,
    total_paket_soal: Number,
  },
  computed: {},
  methods: {
