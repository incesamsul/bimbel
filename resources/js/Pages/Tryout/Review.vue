...
<template>
  ...
  <AuthenticatedLayout :user="user">
    <div class="container-fluid review" id="container-kerjakan">
      <!-- Page Heading -->
                  ...
                  <div v-if="selectedQuestion">
                    ...
                    <ul class="ml-0 pl-0">
                      <li
                        ...
                        :key="pilihanIndex"
                        :class="{
                          'bg-success text-white': jawabanKamu(
                            selectedQuestionIndex,
                            pilihanIndex
                          ),
                          'bg-primary text-white': kunciJawaban(
                            selectedQuestionIndex,
                            pilihanIndex
                          ),
                        }"
            ...
            <div class="col-sm-12">
              <div class="card border-0 mb-4">
                ...
                <div class="card-body">
                  <div class="row">
                    <div
                      class="col-sm-12 my-5 d-flex flex-wrap"
                    ...
                    <div class="col-sm-12">
                      <div class="d-flex justify-content-center">
                        ...
                        <button
                          ...
                          @click="nextQuestion"
                          :disabled="
                            selectedQuestionIndex === tryout_soal.length - 1
                          "
                        >
              ...
              <div class="card border-0 mb-4">
                ...
                >
                  <h6 class="m-0 font-weight-bold text-">
                    Informasi Nomor Soal
                  </h6>
                </div>
                <div class="card-body">
                  <div
                    class="alert bg-correct d-flex justify-content-between align-items-center"
                  >
                    <div class="content">
                  ...
                  <div
                    class="alert bg-wrong d-flex justify-content-between align-items-center"
                  >
                    <div class="content">
                  ...
                  <div
                    class="alert bg-point d-flex justify-content-between align-items-center"
                  >
                    <div class="content">
                      <i class="fas fa-times"></i>
                      Sistem Poin 1-5
          ...
          <div class="card border-0 mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div>
                  <div v-if="selectedQuestion">
                    <p v-if="selectedQuestion.soal.kategori_soal_id == '2'">
                      <strong
                        >Kunci jawaban :
                        {{ selectedQuestion.soal.jawaban }}</strong
                      >
                    </p>
                    <p v-else>
                      <strong
                    ...
                    <p>
                      <strong
                        ...
                        {{
                          ["A", "B", "C", "D", "E"][
                            selectedQuestion.jawaban_tryout
                              ? selectedQuestion.jawaban_tryout.jawaban
                              : ""
                          ]
                        }}</strong
                      >
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              @click="finishSegment(segment_tryout_id)"
...
.review .nomor-soal.flagged {
  background-color: #f6c23e !important;
  color: white !important;
}

.review .nomor-soal.correct {
  background-color: #3dd73a !important;
  color: white !important;
}
...
.review .nomor-soal.wrong {
  background-color: #f63e3e !important;
  color: white !important;
}

.review .nomor-soal.point {
  background-color: #3a3dd7 !important;
  color: white !important;
}
...
.review .nomor-soal.answered {
  background-color: #939393 !important;
  color: white !important;
}

.review .nomor-soal:hover {
...
export default {
  ...
  methods: {
    ...
    isQuestionAnswered(index) {
      ...
      const userAnswer = question.jawaban_tryout
        ? question.jawaban_tryout.jawaban
        : null;
      const correctAnswer = question.soal ? question.soal.jawaban : null;
      if (userAnswer == null) {
        return true;
      } else {
        return false;
    ...
    flagQuestion(pilihanIndex, event) {
      ...
      axios
        .post(`/api/flag-tryout-answer/${this.segment_tryout_id}`, {
    ...
    deleteFlagQuestion(pilihanIndex, event) {
      ...
      axios
        .post(`/api/delete-flag-tryout-answer/${this.segment_tryout_id}`, {
          questionId: questionId,
          user_id: this.user.id,
        })
        .then((response) => {
    ...
    removeQuestion(pilihanIndex, event) {
      ...
      axios
        .post(`/api/delete-tryout-answer/${this.segment_tryout_id}`, {
          questionId: questionId,
          user_id: this.user.id,
        })
        .then((response) => {
    ...
    jawabanKamu(questionIndex, optionIndex) {
      ...
      let jawaban = question.jawaban_tryout
        ? question.jawaban_tryout.jawaban
        : "";
    ...
    selectAnswer(index) {
      ...
      axios
        .post(`/api/save-tryout-answer/${this.segment_tryout_id}`, {
    ...
    fetchDataSoal() {
      axios
        .get(`/api/get-soal/${this.id_tryout}/${this.segment_tryout_id}`)
        .then((response) => {
