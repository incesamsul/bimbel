          ...
          <div class="card border-0 pb-4">
            <div class="card-body">
              <h5 class="main-color text-center text-capitalize">
                <strong>{{ item.nama_tryout }}</strong>
              </h5>
              <div class="row mt-5">
                <div
                ...
                <div class="col-sm-7">
                  ...
                  <div class="alert alert-info">
                    ...
                    mengerjakan tryout lain atau berpindah halaman sebelum
                    menyelesaikan satu tryout dalam satu waktu.
                  </div>
                  <button
...
export default {
  ...
  methods: {
    makeSegment(tryoutId) {
      this.loading = true;
      axios
        .post(`/api/make_segment/${tryoutId}`, {
